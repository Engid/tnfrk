...
// Definitions by: Nick Gideo http://gid.space
 ...
 */
 ...
 //Suggested code from the documentation:
// export as namespace Tone;
//     export = Tone;
// but this doesn't work with the actual module imported from npm


//I'm not sure why this works (using the declare module statements) but i guess it does???
...
declare module 'tone' {
    ...
    export namespace Tone {
        ...
        class Master extends Tone {
            ...
            chain(...args: Tone | AudioNode): Master;
